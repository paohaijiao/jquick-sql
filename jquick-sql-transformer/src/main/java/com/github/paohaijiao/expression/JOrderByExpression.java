...
public class JOrderByExpression {
    ...
    public JOrderByExpression(JExpression expression) {
        this(expression, JSortDirection.ASC);
    }

    public JOrderByExpression(JExpression expression, JSortDirection direction) {
        this(expression, direction, JNullsOrder.UNDEFINED);
    }

    public JOrderByExpression(JExpression expression, JSortDirection direction, JNullsOrder nullsOrder) {
