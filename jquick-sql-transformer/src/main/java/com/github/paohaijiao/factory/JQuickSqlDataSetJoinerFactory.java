...
import com.github.paohaijiao.lamda.JQuickSqlLamdaJoinJoinerHandler;
 ...
 * @since 2025/8/17
 */
public class JQuickSqlDataSetJoinerFactory {

    public static JQuickSqlDataSetJoinerStrategy createJoiner(JQuickSqlEngineEnums type) {
        switch (type) {
//            case MULTI_THREADED:
//                return new JMultiThreadedJoiner();
            case LAMBDA:
                return new JQuickSqlLamdaJoinJoinerHandler();
//            case SPARK:
