...
public class JQuickExistsExpression implements JQuickExpression {
    ...
    private final JQuickSubqueryExpression subquery;
    private final boolean isNotExists;

    public JQuickExistsExpression(JQuickSubqueryExpression subquery, boolean isNotExists) {
    ...
    public Object evaluate(JQuickRow row) {
        JQuickDataSet result = JQuickDataSet.builder().build();
    ...
    public JQuickExpression clone() {
        return new JQuickExistsExpression((JQuickSubqueryExpression) subquery.clone(), isNotExists);
    }

    public JQuickSubqueryExpression getSubquery() { return subquery; }
