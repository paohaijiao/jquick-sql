...
public class JQuickSqlConfig {
    ...
    public JQuickSqlConfig() {
        this.defaultParallelism =1 ;//Runtime.getRuntime().availableProcessors()
    ...
    public JQuickSqlConfig setDefaultParallelism(int defaultParallelism) {
        this.defaultParallelism = defaultParallelism;
        return this;
    }

    public JQuickSqlConfig setMaxTaskRetries(int maxTaskRetries) {
        this.maxTaskRetries = maxTaskRetries;
        return this;
    }

    public JQuickSqlConfig setTaskTimeoutMs(long taskTimeoutMs) {
        this.taskTimeoutMs = taskTimeoutMs;
        return this;
    }

    public JQuickSqlConfig setExecutionMode(String executionMode) {
        this.executionMode = executionMode;
        return this;
    }

    public JQuickSqlConfig setEnableAdaptiveParallelism(boolean enable) {
        this.enableAdaptiveParallelism = enable;
        return this;
    }

    public JQuickSqlConfig setEnableVectorizedExecution(boolean enable) {
        this.enableVectorizedExecution = enable;
        return this;
    }

    public JQuickSqlConfig setBatchSize(int batchSize) {
        this.batchSize = batchSize;
        return this;
    }

    public JQuickSqlConfig setClusterName(String clusterName) {
    ...
    public JQuickSqlConfig setServiceDiscoveryUrl(String url) {
    ...
    public JQuickSqlConfig setHeartbeatIntervalMs(int intervalMs) {
        this.heartbeatIntervalMs = intervalMs;
        return this;
    }

    public JQuickSqlConfig setHeartbeatTimeoutMs(int timeoutMs) {
        this.heartbeatTimeoutMs = timeoutMs;
        return this;
    }

    public JQuickSqlConfig setMaxConcurrentTasksPerWorker(int max) {
        this.maxConcurrentTasksPerWorker = max;
        return this;
    }

    public JQuickSqlConfig setTempDir(String tempDir) {
        this.tempDir = tempDir;
        return this;
    }

    public JQuickSqlConfig setEnableJoinReorder(boolean enable) {
        this.enableJoinReorder = enable;
        return this;
    }

    public JQuickSqlConfig setEnablePredicatePushdown(boolean enable) {
        this.enablePredicatePushdown = enable;
        return this;
    }

    public JQuickSqlConfig setEnableQueryLogging(boolean enable) {
        this.enableQueryLogging = enable;
        return this;
    }

    public JQuickSqlConfig setEnableMetricsCollection(boolean enable) {
        this.enableMetricsCollection = enable;
        return this;
    }

    public JQuickSqlConfig setLogLevel(String logLevel) {
     ...
     * 创建配置副本
     */
    public JQuickSqlConfig copy() {
        JQuickSqlConfig copy = new JQuickSqlConfig();
