...
import com.github.paohaijiao.config.WorkerEndpoint;
...
import com.github.paohaijiao.expression.JQuickExistsExpression;
...
public class JQuickFilterConditionTest {
    ...
    public void setUp() throws IOException, InterruptedException {
        ...
        endpoints.add(new WorkerEndpoint("worker-1", "localhost", WORKER1_PORT, 0));
        endpoints.add(new WorkerEndpoint("worker-2", "localhost", WORKER2_PORT, 1));
        endpoints.add(new WorkerEndpoint("worker-3", "localhost", WORKER3_PORT, 2));
    ...
    public void testIsNullCondition() {
        JQuickTableScanNode usersScan = createTableScan("users", "u");
        JQuickUnaryExpression isNullCondition = new JQuickUnaryExpression(JQuickUnaryOperator.IS_NULL, new JQuickColumnRefExpression("status"));
