...
public class JQuickSQLParser extends Parser {
	...
	public static final int
		...
		FULL=57, CROSS=58, NATURAL=59, USE=60, KEY=61, FOR=62, UNION=63, ALL=64, 
		DISTINCT=65, TRUE=66, FALSE=67, IDENTIFIER=68, STRING_LITERAL=69, DECIMAL_LITERAL=70, 
		HEXADECIMAL_LITERAL=71, BIT_STRING=72, WS=73, COMMENT=74, LINE_COMMENT=75;
	public static final int
	...
	public final FunctionCallContext functionCall() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2199593692360L) != 0) || ((((_la - 66)) & ~0x3f) == 0 && ((1L << (_la - 66)) & 31L) != 0)) {
				{
				setState(372);
				arg();
				}
	...
	public final KeywordContext keyword() throws RecognitionException {
		...
		try {
			...
			setState(561);
			_la = _input.LA(1);
			if ( !(((((_la - 29)) & ~0x3f) == 0 && ((1L << (_la - 29)) & 120259059711L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
