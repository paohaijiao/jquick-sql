...
public class JQuickSQLLexer extends Lexer {
	...
	public static final int
		...
		BIT_STRING=262, WS=263, COMMENT=264, LINE_COMMENT=265;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "T__21", "T__22", "ON", "IS", "NULL", 
			"EXISTS", "DESC", "ASC", "SELECT", "FROM", "WHERE", "GROUP", "BY", "HAVING", 
			"ORDER", "LIMIT", "OFFSET", "AND", "OR", "XOR", "NOT", "IN", "BETWEEN", 
			"AS", "WITH", "RECURSIVE", "ROLLUP", "DRILLDOWN", "SLICE", "DICE", "PIVOT", 
			"JOIN", "INNER", "OUTER", "LEFT", "RIGHT", "FULL", "CROSS", "NATURAL", 
			"USE", "FORCE", "IGNORE", "INDEX", "KEY", "FOR", "ALL", "DISTINCT", "DISTINCTROW", 
