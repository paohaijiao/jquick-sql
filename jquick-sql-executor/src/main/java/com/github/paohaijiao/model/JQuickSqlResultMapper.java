...
import com.github.paohaijiao.util.JQuickSqlEntityAccessor;
 ...
 * @since 2025/8/12
 */
public class JQuickSqlResultMapper<T> {
    private final Class<T> targetClass;
    private final JQuickSqlEntityAccessor<T> targetAccessor;

    public JQuickSqlResultMapper(Class<T> targetClass) {
        this.targetClass = targetClass;
        this.targetAccessor = new JQuickSqlEntityAccessor<>(targetClass);
    }

    public T map(JQuickSqlJoinResult<T> joinResult) {
        try {
    ...
    private void copyJoinedRecordFields(Object joinedRecord, T target, String prefix) {
        ...
        JQuickSqlEntityAccessor<?> sourceAccessor = new JQuickSqlEntityAccessor<>(joinedRecord.getClass());
