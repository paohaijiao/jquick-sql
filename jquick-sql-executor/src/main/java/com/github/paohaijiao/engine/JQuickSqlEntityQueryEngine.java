 ...
 * @since 2025/8/12
 */
public class JQuickSqlEntityQueryEngine<T> {
    ...
    public JQuickSqlEntityQueryEngine(Class<T> entityClass) {
    ...
    public JQuickSqlEntityQueryEngine<T> registerJdbcTable(String tableName, DataSource dataSource) {
        return this;
    }

    public JQuickSqlEntityQueryEngine<T> registerCsvTable(String tableName, Path csvFile) {
        return this;
    }

    public <E> JQuickSqlEntityQueryEngine<T> registerEntityList(Class<E> entityClass, List<E> data) {
        String tableName = entityClass.getSimpleName();
        return registerEntityList(tableName, entityClass, data);
    }

    public <E> JQuickSqlEntityQueryEngine<T> registerEntityList(String tableName, Class<E> entityClass, List<E> data) {
