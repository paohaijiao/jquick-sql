...
//                String resultColName = aggEntry.getKey();
...
//                            } else if (function.getArgument() instanceof JLiteralExpression) {
//                                return ((JLiteralExpression) function.getArgument()).getValue();
//                            }
//                            throw new UnsupportedOperationException("Unsupported expression type in aggregate function");
//                        })
...
//                }
//
//                // Apply aggregate function using JAggregateFunctionFactory
//                Object aggValue = applyAggregateFunction(function, values);
//                resultRow.put(resultColName, aggValue);
//            }
...
//        String functionName = function.getAggregateType();
//        Function<List<Object>, Object> aggregateFunction = JAggregateFunctionFactory.getFunction(functionName);
//        return aggregateFunction.apply(values);
//    }
//
//
//}
