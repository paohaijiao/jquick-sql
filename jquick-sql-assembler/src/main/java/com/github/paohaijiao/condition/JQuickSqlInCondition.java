 ...
 */
@Getter
public class JQuickSqlInCondition extends JQuickSqlCondition {

    private JQuickSqlExpression expression;

    private Boolean not;

    private List<JQuickSqlExpression> list;


    public JQuickSqlInCondition(JQuickSqlExpression expression, Boolean not, List<JQuickSqlExpression> list) {
        this.type = JQuickSqlConditionType.IN;
