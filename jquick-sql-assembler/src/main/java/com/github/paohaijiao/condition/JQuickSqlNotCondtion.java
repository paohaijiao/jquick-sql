 ...
 */
@Getter
public class JQuickSqlNotCondtion extends JQuickSqlCondition {

    private JQuickSqlColumnExpression expression;

    public JQuickSqlNotCondtion(JQuickSqlColumnExpression expression) {
        this.type = JQuickSqlConditionType.NOT;
