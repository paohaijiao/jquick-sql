 ...
 */
@Getter
public class JQuickSqlLikeCondition extends JQuickSqlCondition {
    ...
    public JQuickSqlLikeCondition(JQuickSqlExpression expression, Boolean not, String pattern) {
        this.type = JQuickSqlConditionType.LIKE;
