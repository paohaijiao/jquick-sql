 ...
 */
@Getter
public class JQuickSqlExpressionAtomPredicateCondition extends JQuickSqlCondition {

    private JQuickSqlExpression expression;

    public JQuickSqlExpressionAtomPredicateCondition(JQuickSqlExpression expression) {
        this.type = JQuickSqlConditionType.ATOM;
