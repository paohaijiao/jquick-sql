 ...
 */
@Getter
public class JQuickSqlRegexCondition extends JQuickSqlCondition {
    ...
    public JQuickSqlRegexCondition(JQuickSqlExpression expression, Boolean not, String regex) {
        this.type = JQuickSqlConditionType.REGEX;
