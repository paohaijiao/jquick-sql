 ...
 */
@Getter
public class JQuickSqlUnaryExpression extends JQuickSqlExpression {

    private JQuickSqlExpression expression;

    private JQuickSqlUnaryOperator operator;

    public JQuickSqlUnaryExpression(JQuickSqlUnaryOperator operator, JQuickSqlExpression expression) {
        this.type = JQuickSqlExpressionType.UNARY;
