...
@Getter
public class JQuickSqlDrillDownExpression extends JQuickSqlExpression {
    ...
    public JQuickSqlDrillDownExpression(List<String> groupByColumns, Map<String, Function<List<Object>, Object>> aggregations) {
