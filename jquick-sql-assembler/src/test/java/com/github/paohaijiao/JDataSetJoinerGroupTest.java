...
//                new JAggregateFunction("AVG", new JColumnExpression("salary"))
//        ));
//        aggregations.put("max_experience", new JAggregateExpression(
//                new JAggregateFunction("MAX", new JColumnExpression("years_of_service"))
//        ));
//
//        aggregations.put("employee_count", new JAggregateExpression(
//                new JAggregateFunction("COUNT", new JColumnExpression("employee_name"))
//        ));
//
